...
public class LDAPStoreResourceDefinition extends AbstractIdentityStoreResourceDefinition {
    ...
    public static final SensitiveTargetAccessConstraintDefinition BASE_DN_SUFFIX_CONSTRAINT = new SensitiveTargetAccessConstraintDefinition(new SensitivityClassification(IDMExtension.SUBSYSTEM_NAME, "picketlink-idm-ldap-store-base-dn", false, true, true));
